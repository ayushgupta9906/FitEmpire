...
export function LoginPage() {
  ...
  return (
    ...
    >
      ...
      >
        <CardContent sx={{ p: 5 }}>
          {/* Logo Badge (Matching Member App Exactly: Purple Gradient with White Mirrored Dumbbell) */}
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            >
              <div style={{ display: 'inline-flex', transform: 'scaleX(-1)' }}><Dumbbell size={40} color="#FFFFFF" strokeWidth={2.3} /></div>
            </Box>
            <Typography
              variant="h4"
              sx={{
