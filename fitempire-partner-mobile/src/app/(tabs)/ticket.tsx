...
import { QrCode as QrCodeIcon, MapPin, RefreshCw, Calendar, Clock, ShieldCheck, Dumbbell, Sparkles, ChevronRight, Copy } from 'lucide-react-native';
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.qrSection}>
            <View style={[styles.qrContainer, { backgroundColor: '#FFFFFF', padding: 14, borderRadius: 16 }]}>
              {qrToken ? (
                <QRCode
                  value={qrToken}
                  size={180}
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                Alert.alert('Code Copied! 📋', `Pass token "${qrToken}" copied to clipboard.`);
              }}
            >
