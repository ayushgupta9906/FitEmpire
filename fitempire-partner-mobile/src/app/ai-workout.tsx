...
export default function AiWorkoutScreen() {
  ...
  const handleAiGenerateWorkout = async (muscle: string) => {
    setLoadingAi(true);
    setSelectedMuscle(muscle);
    try {
      await aiApi.generateWorkout();
      // Generate specialized routine based on muscle split
      if (muscle.includes('Chest')) {
        setExercises([
          { id: '1', name: 'Barbell Incline Bench Press', sets: '4 Sets', reps: '8-10 Reps', completed: false },
          { id: '2', name: 'Flat Dumbbell Press', sets: '3 Sets', reps: '10-12 Reps', completed: false },
          { id: '3', name: 'Pec Deck Flyes (Drop Set)', sets: '3 Sets', reps: '15 Reps', completed: false },
          { id: '4', name: 'Cable Rope Tricep Pushdown', sets: '4 Sets', reps: '12-15 Reps', completed: false },
          { id: '5', name: 'Skull Crushers', sets: '3 Sets', reps: '10 Reps', completed: false },
        ]);
      } else if (muscle.includes('Back')) {
        setExercises([
          { id: '1', name: 'Wide-Grip Lat Pulldown', sets: '4 Sets', reps: '10-12 Reps', completed: false },
          { id: '2', name: 'Bent-Over Barbell Rows', sets: '4 Sets', reps: '8-10 Reps', completed: false },
          { id: '3', name: 'Seated Cable Row', sets: '3 Sets', reps: '12 Reps', completed: false },
          { id: '4', name: 'EZ-Bar Bicep Curls', sets: '4 Sets', reps: '10-12 Reps', completed: false },
          { id: '5', name: 'Hammer Curls', sets: '3 Sets', reps: '12 Reps', completed: false },
        ]);
      } else if (muscle.includes('Legs')) {
        setExercises([
          { id: '1', name: 'Barbell Back Squats', sets: '4 Sets', reps: '6-8 Reps', completed: false },
          { id: '2', name: 'Leg Press (Heavy)', sets: '4 Sets', reps: '10-12 Reps', completed: false },
          { id: '3', name: 'Romanian Deadlifts', sets: '3 Sets', reps: '10 Reps', completed: false },
          { id: '4', name: 'Seated Calf Raises', sets: '4 Sets', reps: '15 Reps', completed: false },
          { id: '5', name: 'Hanging Leg Raises', sets: '3 Sets', reps: '15 Reps', completed: false },
        ]);
      } else {
        setExercises([
          { id: '1', name: 'Overhead Dumbbell Shoulder Press', sets: '4 Sets', reps: '8-10 Reps', completed: false },
          { id: '2', name: 'Lateral Cable Raises', sets: '4 Sets', reps: '15 Reps', completed: false },
          { id: '3', name: 'Rear Delt Flyes', sets: '3 Sets', reps: '12 Reps', completed: false },
          { id: '4', name: 'Preacher Curls', sets: '3 Sets', reps: '10 Reps', completed: false },
          { id: '5', name: 'Dips / Tricep Bench Dips', sets: '3 Sets', reps: '15 Reps', completed: false },
        ]);
      }
      Alert.alert('AI Routine Generated ⚡', `FitEmpire AI designed a customized ${muscle} routine.`);
    } catch (e) {
      console.warn('AI generator fallback:', e);
      Alert.alert('Protocol Customized ⚡', `AI generated a new ${muscle} routine.`);
    } finally {
      setLoadingAi(false);
    }
  };
              ...
              {muscleGroups.map((m) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => handleAiGenerateWorkout(m)}
                  >
