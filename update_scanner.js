...
const scannerPath = path.join(__dirname, 'fitempire-mobile', 'src', 'app', '(partner-tabs)', 'scanner.tsx');

const scannerContent = `import React, { useState, useEffect } from 'react';
...
console.log("Updated scanner.tsx with expo-camera");
